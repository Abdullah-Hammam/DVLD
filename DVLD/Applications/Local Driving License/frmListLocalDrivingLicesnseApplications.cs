    ...
    public partial class frmListLocalDrivingLicesnseApplications : Form
    {
        ...
        private void frmListLocalDrivingLicesnseApplications_Load(object sender, EventArgs e)
        {
            ...
            if (dgvLocalDrivingLicenseApplications.Rows.Count > 0)
            {
                ...
                dgvLocalDrivingLicenseApplications.Columns[2].Width = 95;

                dgvLocalDrivingLicenseApplications.Columns[3].HeaderText = "Full Name";
                dgvLocalDrivingLicenseApplications.Columns[3].Width = 245;

                dgvLocalDrivingLicenseApplications.Columns[4].HeaderText = "Application Date";
                dgvLocalDrivingLicenseApplications.Columns[4].Width = 115;

                dgvLocalDrivingLicenseApplications.Columns[5].HeaderText = "Passed Tests";
                dgvLocalDrivingLicenseApplications.Columns[5].Width = 95;
            }
