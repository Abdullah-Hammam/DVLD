...
namespace DVLD.Applications.Rlease_Detained_License
{
    public partial class frmReleaseDetainedLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            clsDetainedLicense DetainedLicenseInfo = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.DetainedInfo;

            lblDetainID.Text = DetainedLicenseInfo.DetainID.ToString();
            lblLicenseID.Text = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.LicenseID.ToString();
           
            lblCreatedByUser.Text = DetainedLicenseInfo.CreatedByUserInfo.UserName;
            lblDetainDate.Text = clsFormat.DateToShort(DetainedLicenseInfo.DetainDate);
