...
namespace DVLD.Licenses.International_Licenses.Controls
{
    public partial class ctrlDriverInternationalLicenseInfo : UserControl
    {
        ...
        private void _LoadPersonImage(clsPerson PersonInfo)
        {
        ...
        public void LoadInfo(int InternationalLicenseID)
        {
            ...
            clsPerson PersonInfo = _InternationalLicense.DriverInfo.PersonInfo;
            ...
            lblDateOfBirth.Text = clsFormat.DateToShort(PersonInfo.DateOfBirth);
