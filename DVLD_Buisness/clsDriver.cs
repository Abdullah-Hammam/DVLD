...
namespace DVLD_Buisness
{
    public class clsDriver
    {
        ...
        public static DataTable GetLicenses(int DriverID) => clsLicense.GetDriverLicenses(DriverID);


        public static DataTable GetInternationalLicenses(int DriverID) => clsInternationalLicense.GetDriverInternationalLicenses(DriverID);
